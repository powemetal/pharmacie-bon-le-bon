  ...
  return (
    <header className="bg-green-700 text-white shadow-md">
      <nav className="max-w-7xl mx-auto px-6 py-6 flex items-center justify-between">
        ...
        <Link
          href="/"
          className="text-2xl font-bold tracking-wide whitespace-nowrap flex-shrink-0"
        >
        ...
        <ul className="flex gap-6 text-lg whitespace-nowrap flex-shrink">
            ...
            {/* les settings pour le collapse progressif sont dans le fichier tailwind.config.ts a la racine du projet*/}
        ...
        <div className="flex items-center gap-4 whitespace-nowrap flex-shrink-0">
          ...
          <div className="hidden connexion:flex gap-1">
            <Link href="/connexion" className="hover:underline">Connexion</Link><p style={{"color":"white"}}>/</p>

      ...
      <div className="w-full max-w-md bg-[var(--card)] p-8 rounded-[var(--radius)] shadow-[var(--shadow)] border border-[var(--accent)]">
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col">
            ...
            <input name="courriel" type="email" placeholder="exemple@courriel.com" className="border rounded px-3 py-2 placeholder-[var(--placeholder)] text-[var(--input)]" required />
          </div>

          {/* Pseudo */}
          <div className="flex flex-col">
            <label className="mb-1 font-medium text-[var(--label)]">Pseudo</label>
            <input name="pseudonyme" type="text" placeholder="Votre nom d'utilisateur" className="border rounded px-3 py-2 placeholder-[var(--placeholder)] text-[var(--input)]" required />
          </div>

          {/* Mot de passe */}
          <div className="flex flex-col">
            <label className="mb-1 font-medium text-[var(--label)]">Mot de passe</label>
            <input name="motDePasse" type="password" placeholder="Votre mot de passe" className="border rounded px-3 py-2 placeholder-[var(--placeholder)] text-[var(--input)]" required />
          </div>
